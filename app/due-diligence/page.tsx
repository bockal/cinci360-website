...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://cinci360.com/images/workflows/due-diligence-hero.webp", width: 1800, height: 694, alt: "Cinci360 due diligence LiDAR survey for existing buildings and retrofit planning" }],
  },
};
