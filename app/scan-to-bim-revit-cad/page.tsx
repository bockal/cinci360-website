...
export default function ScanToBim() {
  return <main className="service-page">
    ...
    <section className="workflow-poster" aria-label="Scan-to-BIM workflow"><img src="/images/workflows/scan-to-bim-workflow.webp" alt="An architectural point cloud becomes a detailed BIM model, floor plan, elevation and section"/><div><span><b>01</b> Point cloud</span><span><b>02</b> BIM model</span><span><b>03</b> CAD drawings</span><span><b>04</b> Design-ready handoff</span></div></section>
