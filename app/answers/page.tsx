...
export default function AnswersPage() {
  return <main className="service-page answers-page">
    ...
    <header className="service-nav"><Link className="brand" href="/"><span>Cinci</span><strong>360</strong></Link><nav><Link href="/projects/estee-lauder-plant">Estée Lauder case study</Link><Link href="/#contact">Start a project</Link></nav></header>
