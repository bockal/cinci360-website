...
export default function Home() {
  ...
  return <main>
    ...
    <section id="reviews" className="reviews"><div className="quote">“</div><blockquote>“Cinci360 made a complicated existing-conditions project feel remarkably straightforward. The data was thorough, the communication was fast, and the final model gave our whole team confidence.”</blockquote><div className="review-meta"><span>★★★★★</span><p>Client review · Cincinnati, Ohio</p></div><div className="review-nav"><button>←</button><span>01 / 03</span><button>→</button></div></section>
