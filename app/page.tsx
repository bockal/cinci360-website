...
const reviewPhotos = [
  ...
  { src: "/assets/reviews/field-review-3.jpg", alt: "Cinci360 technician surveying an express car wash", caption: "Facility survey · Cinci360", position: "38% center" },
  { src: "/assets/reviews/field-review-4.jpg", alt: "Cinci360 technician positioning a survey camera in an automotive parts warehouse", caption: "Existing conditions · Cinci360", position: "center" },
];
const homeSchema = [
  {
    ...
    description: "Cincinnati-based reality capture, LiDAR surveying, Matterport, CAD, Revit and scan-to-BIM services.",
    areaServed: ["Cincinnati", "Ohio", "Kentucky", "Indiana", "Midwest United States", "United States"],
    knowsAbout: ["3D laser scanning", "LiDAR surveying", "reality capture", "Matterport digital twins", "existing conditions", "point clouds", "CAD", "Revit", "scan-to-BIM"],
    sameAs: [
