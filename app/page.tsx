...
export default function Home() {
  ...
  return <main>
    ...
    <section className="clients"><p className="eyebrow">Trusted across Cincinnati and beyond</p><div className="logo-window"><div className="logo-track">{[...logos,...logos].map(([file,name],i)=><div className="logo-item" key={`${file}-${i}`}><Image src={`/assets/logos/${file}`} alt={name} width={220} height={100}/></div>)}</div></div></section>
