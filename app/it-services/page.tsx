...
export default function ITServices() {
  return <main className="service-page">
    ...
    <section className="workflow-poster" aria-label="AI and digital operations workflow"><picture><source media="(max-width: 560px)" srcSet="/images/workflows/ai-digital-operations-workflow-mobile.webp"/><img src="/images/workflows/ai-digital-operations-workflow.webp" alt="Disconnected small-business tasks flow through an AI-assisted system into a website, local-search presence, automation and profitable growth"/></picture><div><span><b>01</b> Find the friction</span><span><b>02</b> Design the workflow</span><span><b>03</b> Connect the tools</span><span><b>04</b> Measure the return</span></div></section>
