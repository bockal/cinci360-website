...
export default function CincinnatiLaserScanning() {
  return <main className="service-page">
    ...
    <section className="workflow-poster" aria-label="3D laser scanning workflow"><img src="/images/workflows/laser-scanning-workflow.webp" alt="A field technician scans an existing building, producing a point cloud and a precise digital building model"/><div><span><b>01</b> Plan the site</span><span><b>02</b> Capture reality</span><span><b>03</b> Register the data</span><span><b>04</b> Deliver usable files</span></div></section>
    ...
    <section className="service-fit"><div><p className="eyebrow">Common questions</p><h2>What comes from a LiDAR survey?</h2></div><p>Deliverables can include registered point clouds, E57 files, Matterport digital twins, 2D CAD drawings, PDFs and Revit models. Cinci360 is based in Cincinnati and supports projects across Ohio, the Midwest and nationwide.</p><Link className="button button-gold" href="/scan-to-bim-revit-cad">See scan-to-BIM deliverables</Link></section>
