...
export default function CincinnatiLaserScanning() {
  return <main className="service-page">
    ...
    <section className="service-proof"><div><p className="eyebrow">Large-scale field work</p><h2>Proven inside complex facilities.</h2></div><article><span>ChangeUp · Trek headquarters</span><h3>Full-facility survey for Trek</h3><p>Cinci360 surveyed the entire Trek Bicycle headquarters facility in Waterloo, Wisconsin for ChangeUp.</p><div className="case-video"><iframe src="https://www.youtube-nocookie.com/embed/ojA0V17TJ94" title="Trek facility 3D laser scanning project" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen/></div><Link href="/projects/trek-waterloo">Read the large-facility case study →</Link></article><article><span>BHDP · Estée Lauder plant</span><h3>Full-facility survey on Long Island</h3><p>Cinci360 scanned the entire Estée Lauder plant on Long Island, New York for BHDP, documenting a large industrial environment for the project team.</p><Link href="/projects/trek-waterloo">Explore the Matterport model →</Link></article></section>
